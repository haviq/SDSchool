...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO kelas (kode_kelas, nama_kelas, wali_kelas, tingkat, kapasitas, tahun_ajaran, status) 
              VALUES ('$kode_kelas', '$nama_kelas', '$wali_kelas', '$tingkat', '$kapasitas', '$tahun_ajaran', '$status')";
...
<head>
    ...
    <title>Tambah Kelas - School Information System</title>
...
<div class="d-flex">
    ...
    <div class="sidebar">
        ...
        <ul class="nav flex-column">
            ...
            <li class="nav-item">
                <a href="../aftarsiswa.php" class="nav-link">
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <a href="../kelas/datakelas.php" class="btn btn-secondary">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
