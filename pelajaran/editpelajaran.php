...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
    $query = "SELECT * FROM pelajaran WHERE id = $id";
...
<head>
    ...
    <title>Edit Pelajaran - School Information System</title>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header bg-warning text-white">
                                <h4 class="mb-0">Form Edit Pelajaran</h4>
                            </div>
                            <div class="card-body">
                                <form method="POST" action="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="kode_pelajaran" value="<?php echo $data['kode_pelajaran']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Nama Pelajaran</label>
                                        <input type="text" class="form-control" name="nama_pelajaran" value="<?php echo $data['nama_pelajaran']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Kelas</label>
                                        <input type="text" class="form-control" name="kelas" value="<?php echo $data['kelas']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="jam_pelajaran" value="<?php echo $data['jam_pelajaran']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Guru Pengajar</label>
                                        <input type="text" class="form-control" name="guru_pengajar" value="<?php echo $data['guru_pengajar']; ?>" required>
                                    </div>
